...
const ValeGuardian : Setup<Player> = cloneSetup(wing1Setup);
ValeGuardian.roles[1].tasks = ["Tank", "Quickness"];

const Gorseval : Setup<Player> = cloneSetup(ValeGuardian);
Gorseval.roles[5].tasks = ["Condi"];

const Sabetha : Setup<Player> = cloneSetup(wing1Setup);
Sabetha.roles[8].tasks = ["Condi", "Kiter"];
Sabetha.roles[5].tasks = ["Condi"];
